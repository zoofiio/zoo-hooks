...
import {ZooCustomCurveMock} from "test/mocks/ZooCustomCurveMock.sol";
...
contract ZooCustomCurveTest is Test, Deployers {
    ...
    function setUp() public {
        ...
        deployCodeTo("test/mocks/ZooCustomCurveMock.sol:ZooCustomCurveMock", abi.encode(manager), address(hook));
    ...
    function test_addLiquidity_native_succeeds() public {
        ZooCustomCurveMock nativeHook = ZooCustomCurveMock(0x1000000000000000000000000000000000002A88);
        deployCodeTo("test/mocks/ZooCustomCurveMock.sol:ZooCustomCurveMock", abi.encode(manager), address(nativeHook));
        (key, id) = initPool(
    ...
    function test_removeLiquidity_notInitialized_reverts() public {
        ZooCustomCurveMock uninitializedHook = ZooCustomCurveMock(0x1000000000000000000000000000000000002A88);
        deployCodeTo(
            "test/mocks/ZooCustomCurveMock.sol:ZooCustomCurveMock", abi.encode(manager), address(uninitializedHook)
        );
